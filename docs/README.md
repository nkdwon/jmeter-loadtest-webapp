...
**Documento completo** com resultados, insights, explicações e estrutura para o relatório LaTeX.
...
2. [Resultados Detalhados](#-resultados-detalhados)
   - [Teste 1: Carga Esparsa](#teste-1-carga-esparsa-10-usuários)
   - [Teste 2: Carga Crescente](#teste-2-carga-crescente-500-usuários)
   - [Teste 3: Rajada de Carga](#teste-3-rajada-de-carga-1000-usuários)
3. [Análise Comparativa](#-análise-comparativa)
4. [Identificação de Gargalos](#-identificação-de-gargalos)
5. [Recomendações Técnicas](#-recomendações-técnicas)
6. [5 Insights Principais](#-5-insights-principais)
7. [Estrutura para Relatório LaTeX](#-estrutura-para-relatório-latex)
...
## 📝 Estrutura para Relatório LaTeX
...
\title{Análise de Performance de Aplicação Web Node.js usando Apache JMeter}
\author{[Seus Nomes]}
\date{\today}
...
\begin{abstract}
% Resumo executivo (8-10 linhas)
% Mencionar: 3 testes, resultados principais, capacidade estimada
\end{abstract}

\section{Introdução}
% 1-2 páginas
% - Contexto sobre testes de carga
...
\section{Metodologia}
% 2-3 páginas
% - Ferramentas utilizadas (JMeter, Node.js, SQLite)
% - Ambiente de teste (especificações)
% - Configuração dos 3 testes
%   - Teste 1: 10 usuários, baseline
%   - Teste 2: 500 usuários, escalabilidade
%   - Teste 3: 1000 usuários, pico
% - Métricas coletadas
% - Endpoints testados
...
\subsection{Teste 1: Carga Esparsa (10 Usuários)}
% - Tabela com métricas
% - Incluir screenshot: teste1_summary_report.png
% - Análise: Sistema perfeito, 0% erro, baseline estabelecido

\subsection{Teste 2: Carga Crescente (500 Usuários)}
% - Tabela com métricas
% - Incluir screenshots: teste2_summary_report.png, teste2_response_time_graph.png
% - Análise: Degradação de 25%, gargalos de CPU e SQLite
% - Explicar POR QUE a taxa de erro não é falha do teste

\subsection{Teste 3: Rajada de Carga (1000 Usuários)}
% - Tabela com métricas
% - Incluir screenshots: teste3_summary_report.png, teste3_response_time_graph.png
% - Análise: Degradação crítica de 39%, limite de conexões
% - Explicar comportamento contra-intuitivo (tempo menor, erro maior)

\section{Análise Comparativa}
% 2-3 páginas
% - Incluir gráfico: 01-comparativo-geral.png
% - Incluir gráfico: 02-escalabilidade.png
% - Discussão sobre comportamento não-linear
% - Comparação de métricas entre os 3 testes
% - Evolução da taxa de erro (0% → 25% → 39%)
% - Throughput vs Qualidade (122 req/s mas 39% erro)

\section{Identificação de Gargalos}
% 2-3 páginas
% - Incluir gráfico: 04-identificacao-gargalos.png
% - Ranking dos 3 gargalos:
%   1. Conexões Simultâneas (39%)
%   2. CPU - Heavy-CPU (31.84%)
%   3. SQLite - Escrita (19.44%)
% - Matriz de impacto
% - Explicação técnica de cada gargalo
% - Por que cada um ocorre
...
% - Adicionar referências técnicas (Node.js docs, PostgreSQL docs)

\section{Conclusão}
% 1-2 páginas
% - Retomar objetivos
% - Resumir principais descobertas
% - Usar os 5 insights principais:
%   1. Comportamento não-linear
%   2. Gargalos múltiplos
%   3. Alta eficiência, baixa disponibilidade
%   4. Rede não é gargalo
%   5. Capacidade: ~500 usuários
% - Trabalhos futuros
...
**Tabela 1: Resumo dos 3 Testes**
```latex
\begin{table}[h]
\centering
\begin{tabular}{lrrrrr}
\toprule
Teste & Usuários & Requisições & Erro (\%) & Tempo Médio (ms) & Throughput (req/s) \\
\midrule
Teste 1 & 10 & 200 & 0.00 & 1 & 7.42 \\
Teste 2 & 500 & 5.000 & 25.52 & 12.292 & 18.69 \\
Teste 3 & 1.000 & 3.000 & 39.27 & 2.968 & 122.26 \\
\bottomrule
\end{tabular}
\caption{Resumo das métricas dos 3 testes de carga}
\label{tab:resumo-testes}
\end{table}
```

**Tabela 2: Ranking de Gargalos**
```latex
\begin{table}[h]
\centering
\begin{tabular}{llrr}
\toprule
Gargalo & Teste & Taxa de Erro (\%) & Severidade \\
\midrule
Conexões Simultâneas & Teste 3 & 39.00 & Crítica \\
CPU (Heavy-CPU) & Teste 2 & 31.84 & Alta \\
SQLite (Escrita) & Teste 2 & 19.44 & Média \\
\bottomrule
\end{tabular}
\caption{Ranking de gargalos identificados}
\label{tab:gargalos}
\end{table}
```
...
**Obrigatórios:**
1. `01-comparativo-geral.png` - Seção 4 (Análise Comparativa)
2. `04-identificacao-gargalos.png` - Seção 5 (Gargalos)

**Recomendados:**
3. `02-escalabilidade.png` - Seção 4 (Análise Comparativa)
4. `teste2_summary_report.png` - Seção 3.2 (Resultados Teste 2)
5. `teste3_summary_report.png` - Seção 3.3 (Resultados Teste 3)

### Dicas para Redação

**✅ FAÇA:**
- Use dados concretos: "tempo aumentou de 1ms para 12.292ms"
- Compare resultados: "Enquanto o Teste 1 teve 0% erro, o Teste 2 apresentou 25.52%"
- Justifique recomendações: "Migrar para PostgreSQL porque SQLite não suporta escrita concorrente"
- Cite figuras: "Conforme mostrado na Figura \ref{fig:comparativo}..."
- Use verbos no passado: "Foi realizado", "O sistema apresentou"

**❌ NÃO FAÇA:**
- Copiar blocos grandes sem adaptar
- Deixar tabelas sem interpretação
- Incluir gráficos sem discuti-los
- Fazer afirmações sem evidências
...
1. Apache JMeter User's Manual - https://jmeter.apache.org/usermanual/
2. Node.js Performance Best Practices - https://nodejs.org/en/docs/guides/
3. SQLite Documentation - https://www.sqlite.org/docs.html
4. PostgreSQL Documentation - https://www.postgresql.org/docs/

### Livros
1. "The Art of Application Performance Testing" - Ian Molyneaux
2. "Web Scalability for Startup Engineers" - Artur Ejsmont
3. "Node.js Design Patterns" - Mario Casciaro

### Papers
- Buscar no Google Scholar: "load testing web applications"
- Buscar no Google Scholar: "performance bottleneck identification"
- Buscar no Google Scholar: "SQLite vs PostgreSQL concurrency"
...
- [ ] 3-5 screenshots incluídos
- [ ] Todas as figuras têm legendas
- [ ] Todas as tabelas têm captions
- [ ] Figuras e tabelas são citadas no texto

### Conteúdo Técnico
- [ ] Descrição do JMeter
- [ ] Descrição da aplicação testada
- [ ] Configuração dos 3 testes explicada
- [ ] Análise de cada teste individual
- [ ] Comparação entre os testes
- [ ] Identificação de gargalos com evidências
- [ ] 8 Recomendações técnicas justificadas

### Qualidade Acadêmica
- [ ] Introdução contextualiza o tema
- [ ] Metodologia é reproduzível
- [ ] Resultados são objetivos (dados)
- [ ] Discussão interpreta os dados
- [ ] Conclusão responde aos objetivos
- [ ] Referências bibliográficas citadas

### 5 Insights Principais
- [ ] 1. Comportamento não-linear mencionado
- [ ] 2. Gargalos múltiplos explicados
- [ ] 3. Eficiência vs disponibilidade discutido
- [ ] 4. Rede não é gargalo comprovado
- [ ] 5. Capacidade estimada declarada

---

**Tempo estimado para escrever o relatório**: 8-12 horas

**Boa sorte, Raquel! Todo o material está aqui. É só redigir! 💪📝**

_Documento preparado por Felipe - Novembro 2024_
